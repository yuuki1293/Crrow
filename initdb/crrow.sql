...
-- -----------------------------------------------------
-- Table `Crrow`.`Room_comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Crrow`.`Room_comment` (
  ...
  INDEX `fk_Room_comment_Room1_idx` (`Room_id` ASC) VISIBLE,
  CONSTRAINT `fk_User_has_User_User3`
    FOREIGN KEY (`User_id`)
    REFERENCES `Crrow`.`User` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Room_comment_Room1`
    FOREIGN KEY (`Room_id`)
...
CREATE TABLE IF NOT EXISTS `Crrow`.`DM` (
  ...
  INDEX `fk_sender_user` (`sender` ASC) VISIBLE,
  INDEX `fk_receiver_user` (`receiver` ASC) VISIBLE,
